<script setup>
  ...
  import Galleries from "@/components/detail/Gallery.vue";
  ...
  //kalau false menandakan datanya belum di ambil
  ...
  <main v-if="item">
    <div class="container p-2 mx-auto my-10 max-w-7xl">
      ...
      <main role="main" class="w-full px-4 pt-1 sm:w-2/3 md:w-2/3">
        ...
        <Galleries :defaultImage="item.thumbnails" :galleries="item.galleries" />
