        ...
        <div class="flex flex-col items-center w-full sm:justify-center sm:pt-0">
            ...
            <div class="grid grid-cols-1 gap-12 md:grid-cols-2">
                ...
                <div class="p-8 border rounded-3xl">
                    ...
                    <router-link to="/success"
                    class="inline-flex items-center justify-center w-full px-8 py-3 text-base font-medium text-white bg-indigo-500 border border-transparent rounded-full hover:bg-indigo-700 md:py-2 md:text-md md:px-10 hover:shadow">
                    Checkout Now
                    </router-link>
                </div>
                </div>
